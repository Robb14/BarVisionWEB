      ...
      <div class="container mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between">
        <div class="flex items-center">
          <a href="/" class="flex items-center">
            <img src="../../assets/logo.png" alt="eDreams" class="h-16 mr-2">
          </a>
        ...
        <nav :class="{ 'block': isMenuOpen, 'hidden': !isMenuOpen }" class="sm:flex sm:items-center sm:space-x-8">
          ...
          <div class="mt-4 sm:mt-0">
            ...
            <router-link to="/signup" class="bg-white text-gray-900 font-medium py-2 px-4 rounded-full transition-colors duration-300 hover:bg-gray-400 hover:text-white">Create Account</router-link>
          </div>
        </nav>
      </div>
    </header>
